var url   = "http://buw.nameu.com.br/api";
...
var gblenviroment   = false; // true = sandbox ; false = production
	...
	if(gblapay["method"] == "LOJA"){
		...
		if(hasSessionId){
			...
			var dados = {paymentMode: 'default'
						...
						, currency: 'BRL'
						, notificationURL: 'http://client.nameu.com.br/api/payment/pagseguro/listenpayment'
